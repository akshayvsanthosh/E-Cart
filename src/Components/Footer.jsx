...
function Footer() {
  return (
    <div   className='p-5 mt-5 w-100 bg-info '>
      <div className="d-lg-flex justify-content-between ">
        <div style={{width:'400px'}} className="intro">
          <h5><Link className='fw-bolder ' to={'/'} style={{color:"#fff", textDecoration:"none"}}><i className='fa-solid fa-truck-fast pe-2'></i> FF Store </Link></h5>
        ...
        <p className='text-center text-white  mt-5 mb-0'>Copyright © FF Store 2024 . Built with React.</p>
